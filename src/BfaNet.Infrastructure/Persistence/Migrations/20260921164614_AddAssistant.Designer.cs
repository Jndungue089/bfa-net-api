...
namespace BfaNet.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921164614_AddAssistant")]
    partial class AddAssistant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BfaNet.Domain.Entities.Card", b =>
                {
                    ...
                    b.Property<bool>("AtmWithdrawals")
                        .HasColumnType("boolean")
                        .HasColumnName("atm_withdrawals");
                    ...
                    b.Property<bool>("InternationalPayments")
                        .HasColumnType("boolean")
                        .HasColumnName("international_payments");
            ...
            modelBuilder.Entity("BfaNet.Domain.Entities.CustomerAvatar", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uuid")
                        .HasColumnName("customer_id");
                    ...
                    b.HasKey("CustomerId")
                        .HasName("pk_customer_avatars");

                    b.ToTable("customer_avatars", null, t =>
                        {
                            t.HasCheckConstraint("ck_customer_avatars_size", "octet_length(data) <= 307200");
                        });
                });

            modelBuilder.Entity("BfaNet.Domain.Entities.DeviceCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CustomerId")
                        .HasDatabaseName("ix_device_credentials_customer_id")
                        .HasFilter("revoked_at IS NULL");

                    b.HasIndex("TokenHash")
                        .IsUnique()
                        .HasDatabaseName("ix_device_credentials_token_hash");
            ...
            modelBuilder.Entity("BfaNet.Domain.Entities.Loan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CustomerId")
                        .IsUnique()
                        .HasDatabaseName("ux_loans_one_active_per_customer")
            ...
            modelBuilder.Entity("BfaNet.Domain.Entities.LoanInstallment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("LoanId", "Number")
                        .IsUnique()
                        .HasDatabaseName("ix_loan_installments_loan_id_number");

                    b.ToTable("loan_installments", null, t =>
                        {
                            t.HasCheckConstraint("ck_loan_installments_amount_positive", "amount > 0");
                        });
                });
            ...
            modelBuilder.Entity("BfaNet.Domain.Entities.CustomerAvatar", b =>
                {
                    b.HasOne("BfaNet.Domain.Entities.Customer", null)
                        .WithOne()
                        .HasForeignKey("BfaNet.Domain.Entities.CustomerAvatar", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_customer_avatars_customers_customer_id");
                });
            ...
            modelBuilder.Entity("BfaNet.Domain.Entities.DeviceCredential", b =>
                {
                    b.HasOne("BfaNet.Domain.Entities.Customer", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_device_credentials_customers_customer_id");
                });
            ...
            modelBuilder.Entity("BfaNet.Domain.Entities.Loan", b =>
                {
                    b.HasOne("BfaNet.Domain.Entities.Account", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_loans_accounts_account_id");
            ...
            modelBuilder.Entity("BfaNet.Domain.Entities.LoanInstallment", b =>
                {
                    b.HasOne("BfaNet.Domain.Entities.Loan", null)
